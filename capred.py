...
load_model = load('G:\\Intern\\final_predict\\RandomForest_ModelCa.joblib')
...
# Load the dataset
df = pd.read_csv("G:\\Intern\\final_predict\\interpolatedca.csv")  # Replace "your_csv_file.csv" with the path to your CSV file
